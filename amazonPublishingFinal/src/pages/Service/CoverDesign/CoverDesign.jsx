...
const CoverDesign = () => {
  return (
    <>
      <div id='banner'>
        <NavBar />
        <Banner heading="Design that makes a statement." subHeading="Crafting Eye-catching Book Cover Designs to Inspire You and Your Readers" paragraph="It's not just about judging a book by its cover. Attractive book covers can persuade the readers to buy a book; that’s why it’s essential to a book’s success. Our expert designers at Amazon Author Solutions know precisely how to design a book cover that sells!" />
      </div>
