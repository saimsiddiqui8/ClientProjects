                                    ...
                                    <Row className='ms-5 ps-5 mt-5 ' id='contactTasks'>
                                        <div className="d-flex align flex-row">
                                            ...
                                            <span className='ps-3'>
                                                ...
                                                <p className="mt-1"> <a href="tel:(888) 783 3146" className='text-white'>(888) 783 3146 </a></p>
                                            </span>
                                        </div>
                                    </Row>
                                    <Row className='ms-5 ps-5 mt-5' id='contactTasks'>
                                    ...
                                    <Row className='ms-5 ps-5 mt-5 ' id='contactTasks'>
                                        <div className="d-flex align flex-row">
                                            ...
                                            <span className='ps-3'>
                                                ...
                                                <p className="mt-1"><a className="text-white" target="_blank" href="mailto:contact@amazonauthorsolutions.com"> contact@amazonauthorsolutions.com </a></p>
                                            </span>
                                        </div>
                                    </Row>
                                </Col>
