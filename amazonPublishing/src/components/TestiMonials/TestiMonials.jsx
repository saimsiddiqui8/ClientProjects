                                ...
                                testiMonials.length === 0 ?
                                    <div className="item">
                                        <div className="shadow-effect">
                                            <img className="img-circle" src={userPic} alt={userPic} />
                                            <p>Loree magna.</p>
                                        </div>
                                    ...
                                    testiMonials.map((testiMonialDetail, key) => {
                                        return (
                                            <TestiMonialsDetails className="shadow" testiMonialDetail={testiMonialDetail} key={key} />
