...
const Printing = () => {
  return (
    <>
      <div id='banner'>
        <NavBar />
        <Banner heading="Quick, Efficient, And Affordable" subHeading="Top-Quality Book Printing And Delivery Services At Amazon Author Solutions." paragraph="With hundreds of successful book printing projects completed last year, we understand our authors’ and their audiences’ needs. Whether you need only 100 copies or 10,000, Amazon Author Solutions have got your back!" />
      </div>
