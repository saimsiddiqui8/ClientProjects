...
const Illustrations = () => {
  ...
  return (
    <>
      <div id='banner'>
        <NavBar />
        <Banner heading="Encapsulating illustrations to bring your books to life"  paragraph="At Amazon Author Solutions, our team of creative illustrators provide 100% orignal illustration for all types of books." />
      </div>
        ...
        <Row className='justify-content-evenly'>
          ...
          <Col className="mt-5" lg={6}>
            <div id='aboutContent' className=''>
              ...
              Whether you're looking for illustrations for your book cover or the entire book, Amazon author solution professional team of book illustrators will create engaging illustrations that will attract your audiences at first glance.
              </p>
