...
const AuthorWebsite = () => {
  ...
  return (
    <>
      <div id='banner'>
        <NavBar />
        <Banner heading="Step Into The Digital World"  paragraph="Looking to build your author’s website that showcases your books, grows your reader’s list, and attracts publishers and promoters? Let Amazon Author Solutionstake care of it." />
      </div>
