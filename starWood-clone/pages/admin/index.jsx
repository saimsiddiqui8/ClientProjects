...
export default function Admin() {
    ...
    const AdminAddProduct = () => {
        ...
        return (
            <>
                ...
                <Container className="my-5 w-75 rounded overflow-hidden" id="adminContainer">
                    <Form onSubmit={handleSubmit} className="p-5 adminFormAddProduct">
                        <Form.Group className="mb-3" controlId="names">
                            <Form.Label className="adminFormLabel">Names</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                type="text"
                                value={names}
                        ...
                        <Form.Group className="mb-3" controlId="price">
                            <Form.Label className="adminFormLabel">Price</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                type="text"
                                value={price}
                        ...
                        <Form.Group className="mb-3" controlId="bed">
                            <Form.Label className="adminFormLabel">Bed</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                type="number"
                                value={bed}
                        ...
                        <Form.Group className="mb-3" controlId="area">
                            <Form.Label className="adminFormLabel">Area (Also Include Size For Eg: 1,983 Sq.Ft.)</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                type="text"
                                value={area}
                        ...
                        <Form.Group className="mb-3" controlId="description">
                            <Form.Label className="adminFormLabel">Description</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                as="textarea"
                                rows={4}
                        ...
                        <Form.Group className="mb-3" controlId="cartDescription">
                            <Form.Label className="adminFormLabel">Cart Description</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                as="textarea"
                                rows={2}
                        ...
                        <Form.Group className="mb-3" controlId="location">
                            <Form.Label className="adminFormLabel">Location</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                type="text"
                                value={location}
                        ...
                        <Form.Group className="mb-3" controlId="image">
                            <Form.Label className="adminFormLabel">Images</Form.Label>
    ...
    const AdminAddBlog = () => {
        ...
        return (
            <>
                <h2 className="text-center mt-3 mb-2">Add Blog</h2>
                <Container className="my-5 w-75 rounded overflow-hidden" id="adminContainer">
                    <Form onSubmit={handleSubmit} className="p-5 adminFormAddProduct">
                        <Form.Group className="mb-3" controlId="names">
                            <Form.Label className="adminFormLabel">Title</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                type="text"
                                value={title}
                        ...
                        <Form.Group className="mb-3" controlId="date">
                            <Form.Label className="adminFormLabel">Date</Form.Label>
                            <Form.Control
                                className="adminFormControl"
                                type="text"
                                value={date}
                        ...
                        <Form.Group className="mb-3" controlId="image">
                            <Form.Label className="adminFormLabel">Images</Form.Label>
                            <Form.Control type="file" onChange={handleImageChange} required accept="image/*" />
                    ...
                    <Row className="container px-5 text-center mx-auto ">
                        {images.map((image, index) => (
                            <Col xs={12} lg={3} sm={6} md={4} key={index} className='text-center'>
                                <Card id='' className='my-3 text-center' >
                                    <Card.Img variant="top" src={URL.createObjectURL(image)} className="img-fluid" />
                                    <Card.Body>
                                        <Button
                                            variant="danger"
    ...
    const AllProducts = () => {
        ...
        const handleDeleteProduct = async (productId, imageUrls) => {
            try {
                ...
                await deleteDoc(doc(db, 'propertyForSale', productId)); // Specify the correct document ID
        ...
        return (
            <>
                <div className="text-end">
                    <Button className="mb-3 bg-dark" onClick={handleLogout}>
                        Logout
                    </Button>
                </div>

                {!showAllCategories && !addProduct && !addBlog && !selectedCategory && (
                    <div className="container w-50 text-center twoBtns">
                        <Button
                ...
                {!showAllCategories && !addProduct && !addBlog && !selectedCategory && (
                    <div className="text-center container w-50 twoBtns">
                        <Button
                            className="w-100 py-5 mt-3 bg-dark text-white"
                ...
                {addBlog && <AdminAddBlog />}

                {showAllCategories && !addProduct && !addBlog && !selectedCategory && (
                    <div className="grid-container container w-75 text-center allCategories">
                        <Button
        ...
        <Container className="my-5">
            {loggedIn ? (
                ...
                <>
                    ...
                    <Form onSubmit={handleLogin} className="w-50 mx-auto mt-4 loginForm">
