...
export default function OxwardGardenDubai() {
    ...
    const loadData = async () => {
        try {
            ...
            if (filterValues.property !== '') {
                q = query(q, where('property', '==', "oxwardGarden"));
            }
    ...
    return (
        <>
            <>
                <ShadedContainer mainHeading="Oxward Garden Dubai" currentPage="Oxward Garden Dubai" />
