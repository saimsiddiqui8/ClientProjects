...
export default function apartmentForRent() {

    return (
        <>
            <ShadedContainerTwo mainHeading="Apartment For Rent" currentPage="Apartment For Rent" imgScr="/images/Apartments-for-Sale.jpg" />
