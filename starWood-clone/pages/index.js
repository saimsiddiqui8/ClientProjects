      ...
      <main id='mainHomeWrapper' className='container w-75'>
        <section className=' text-white text-center'>
          <div className='row overflow-hidden'>
            ...
            <div className='col-lg-4 col-md-4 col-sm-12 mt-4 shadow-sm'>
              <Link href="/forSale/propertiesForSale">
            ...
            <div className='col-lg-4 col-md-4 col-sm-12 mt-4 shadow-sm'>
              <Link href="/forRent/propertyForRent">
                <div className='boxes bg-dark pb-3 text-center'>
                  <div className={styles.main}>
                    <div className='text-center pt-3 pb-1'>
                      <img src='/images/logos1.png' width={50} alt='logos' />
            ...
            <div className='col-lg-4 col-md-4 col-sm-12 mt-4 shadow-sm'>
              <Link href="/services/propertyManagement">
                <div className='boxes bg-dark pb-3 text-center'>
                  <div className={styles.main}>
                    <div className='text-center pt-3 pb-1'>
                      <img src='/images/logos1.png' width={50} alt='logos' />
        ...
        <section className=''>
          ...
          <div className='row'>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              ...
              <Card className='rounded shadow mt-3'>
                <Link href="/readyProjects/DubaiHillEstate" >
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              ...
              <Card className='rounded shadow mt-3'>
                <Link href="/readyProjects/palmJumera" >
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              ...
              <Card className='rounded shadow mt-3'>
                <Link href="/readyProjects/DubaiSportsCity" >
          ...
          <div className='my-5 text-center'>
            <Link href="/readyProjects" passHref>
              <button className='btn-stylish'>Ready Projects</button>
            </Link>
          </div>
          <div className='mt-5'>
          ...
          <div className='row'>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              ...
              <Card className='rounded shadow mt-3'>
                <Card.Img variant="top" src="/images/apartmentsCart.jpg" />
                <Card.Body className='text-center'>
                  <Card.Title className='fw-bold'>APARTMENTS </Card.Title>
                  <Card.Text>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              ...
              <Card className='rounded shadow mt-3'>
                <Card.Img variant="top" src="/images/villasCart.jpg" />
                <Card.Body className='text-center'>
                  <Card.Title className='fw-bold'>VILLAS </Card.Title>
                  <Card.Text>
            ...
            <div className="col-lg-4 col-md-4 col-sm-12">
              ...
              <Card className='rounded shadow mt-3'>
                <Card.Img variant="top" src="/images/officesCart.jpg" />
                <Card.Body className='text-center'>
                  <Card.Title className='fw-bold'>OFFICES </Card.Title>
                  <Card.Text>
          ...
          <div>
            ...
            >
              ...
              <Tab eventKey="Book Editing Service" title="Jumeirah Village Circle">
                <section className='tabBackground4'>0
                  <div className="tabShade">
                    <div className="bottomLeftText">
        ...
        <div className='my-5 text-center'>
          <Link href="/services/dubaiAreaGuides" passHref>
            <button className='btn-stylish'>More Areas</button>
          </Link>
        </div>
