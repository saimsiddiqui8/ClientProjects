            ...
            <div id='mainSection'>
                <section>
                    <div id="mainHeadingConferences" className="mt-5">
                        <h1 id="headingContentConferences" className="text-center py-5">Conferences</h1>
                    </div>
                    <div>
                        <Heading classN="my-5" data="Entertainment" />
                        <Container>
                ...
                <section>
                    <div>
                        <Heading classN="my-5" data="Marketing" />
                        <Container>
                            <Row className='justify-content-evenl text-center'>
                                <Col lg={3} md={6} sm={12}>
                                    <div className='shadow rounded py-5'>
                ...
                <section>
                    <div>
                        <Heading classN="my-5" data="Innovation" />
                        <Container>
                            <Row className='justify-content-evenl text-center'>
                                <Col lg={3} md={6} sm={12} className='w-100'>
