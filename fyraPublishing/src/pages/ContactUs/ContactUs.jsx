                                        ...
                                        <Row className='ms-5 ps-5 mt-5 text-dark' id='contactTasks'>
                                            <div className="d-flex align flex-row">
                                                ...
                                                <span className='ps-3'>
                                                    ...
                                                    <p className="mt-1"> <a href="tel:(737) 910 3898" className='text-dark'>(737) 910 3898 </a> </p>
                                                </span>
                                            </div>
                                        </Row>
                                        <Row className='ms-5 ps-5 mt-5 text-dark' id='contactTasks'>
                                        ...
                                        <Row className='ms-5 ps-5 mt-5 text-dark' id='contactTasks'>
                                            <div className="d-flex align flex-row">
                                                ...
                                                <span className='ps-3'>
                                                    ...
                                                    <p className="mt-1"> <a className="text-dark" target="_blank" href="mailto:contact@fyrapublishing.com"> contact@fyrapublishing.com </a></p>
                                                </span>
                                            </div>
                                        </Row>
                                    </Col>
