...
const WritingPublishing = () => {
  ...
  return (
    <>
      <div id='banner'>
        <NavBar />
        <Banner heading="Get Your Customized Book Through Our Expert Writers" paragraph="At Fyra Publishing, our team of executive e-book writers take your ideas and transform them into top-quality books at affordable prices." />
      </div>
