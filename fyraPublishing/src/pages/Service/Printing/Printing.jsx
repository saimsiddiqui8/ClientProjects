...
const Printing = () => {
  return (
    <>
      <div id='banner'>
        <NavBar />
        <Banner heading="Quick, Efficient, And Affordable" subHeading="Top-Quality Book Printing And Delivery Services At Fyra Publishing." paragraph="With hundreds of successful book printing projects completed last year, we understand our authors’ and their audiences’ needs. Whether you need only 100 copies or 10,000, Fyra Publishing have got your back!" />
      </div>
      <Container className='overflow-hidden mb-5'>
        <Row className='justify-content-evenly'>
          <Col className='mt-5 text-center' lg={6} >
            <img src={mockup10} alt="" style={{ width: "90%" }} />
          </Col>
          <Col className="mt-5" lg={6}>
            <div id='aboutContent' className='mt-5'>
              ...
              Whether you're looking for illustrations for your book cover or the entire book, Amazon Author Solution's professional team of book illustrators will create engaging illustrations that will attract your audiences at first glance.
              </p>
