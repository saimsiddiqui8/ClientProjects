                ...
                <div className='container w-50 my-5' id="faqQuestAns">
                    <Accordion defaultActiveKey="" id='faq' style={{ border: "none !important" }}>
                        <Accordion.Item className="mt-1" eventKey="0">
                            <Accordion.Header>How can Fyra Publishing help me publish my book?</Accordion.Header>
                            <Accordion.Body>
                                Fyra Publishing is an assistance provider to online publishing services for Fyra Publishing and many other platforms. With Fyra Publishing you can get your book published and promoted with the help of expert consultants and apt marketing solutions.
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item className="mt-1" eventKey="1">
                            <Accordion.Header>What do I need to publish my book?</Accordion.Header>
                            <Accordion.Body>
                                The first thing you need is an idea for a book. We can take care of everything else. Whether it's ghostwriting, editng or publishing, Fyra Publishing can help you get through the hurdles of getting your book published and live for sales.
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item className="mt-1" eventKey="2">
                            <Accordion.Header>Can Fyra Publishing write my book for me?</Accordion.Header>
                            <Accordion.Body>
                                Fyra Publishing has extensive teams of diverse writers and editors who can write your book for you or help you write your book yourself. No matter what the subject of your choice is, we can accomodate a wide range of writers for your book.
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item className="mt-1" eventKey="3">
                            <Accordion.Header>How can Fyra Publishing help sell my book?</Accordion.Header>
                            <Accordion.Body>
                                Fyra Publishing gives multiple book marketing services to help you build a credible profile across many channels and platforms to promote your book by taking it to your relevant target audience. With a 360 strategy and innovative approach, Fyra Publishing can uplift your book sales and make you a prominent author online.
                            </Accordion.Body>
                        </Accordion.Item>
