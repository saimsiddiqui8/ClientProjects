...
const AudiobookNarration = () => {
  return (
    <>
      <div id='banner'>
        <NavBar />
        <Banner heading="Audiobook Production Services Online" subHeading="Fyra Publishing Pros can help you reach new audiobook readers" paragraph="With over 100 million titles available, Fyra Publishing Pros can help you reach new audiobook readers by publishing your book with our audio book service. With our fast turnaround time and affordable rates, we are the best choice for publishers looking for a professional audio book option." />
      </div>
